...
public interface SooooosSongsRepository extends JpaRepository<SooooosSong, Long> {
    ...
    @Query(value =
            ...
            """,
            nativeQuery = true)
    List<SooooosSong> findSongsNotInTemp();
    ...
    @Query(value =
            ...
            """,
            nativeQuery = true)
    List<SooooosSong> findTempSongsNotInSongs();
}
