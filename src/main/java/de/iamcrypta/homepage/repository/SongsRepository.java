...
public interface SongsRepository extends JpaRepository<Song, Long> {
     ...
     */
    @Modifying
    @Query("delete from Song s where s.addedBy=:addedBy and s.dateAdded=:dateAdded and s.isLocalTrack=:isLocalTrack and s.durationMs=:durationMs and s.songName=:songName and s.spotifyExternalUrl=:spotifyExternalUrl and s.spotifySongId=:spotifySongId")
